 ...
 *
 * This file handles views for WordPress home (blog or index, depending on your settings) and archives when navigating through pages.
...
<section id="archive-container" class="<?php agnosia_content_colspan(); ?> <?php agnosia_post_class(); ?>">
	...
	<?php if ( have_posts() ) : ?>
			...
			<div class="entry <?php agnosia_post_class(); ?>">
				...
				<h2 class="pagetitle"><?php agnosia_archive_title(); ?></h2>
